...
public class EVNDKDriver {
  ...
  public static final int SQLC_EV_API_VERSION = 9;
  ...
  /** Interface to C language function: <br> <code> sqlc_handle_t sqlc_new_ev_dboc(int sqlc_ev_api_version); </code>    */
  public static native long sqlc_new_ev_dboc(int sqlc_ev_api_version);
